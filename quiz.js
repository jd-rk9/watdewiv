const rivetsData = {
    ...
    questions: [{
        ...
        {
            question: 'Welke orginisaties zijn er tegen de slepwet?',
            answers: [
                { description: 'Bits of Freedoms, Raad van Staten, Amnesty International & Computer Club Geulle.', accepted: true },
                { description: 'AIVD, MIVD' },
                { description: 'Libertarische Partij, VPNgids, De Partij voor de Dieren, Privacy First', accepted: true }
            ]
        },
        {
